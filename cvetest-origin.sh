...
BUILD="BUILD-$1"
TMP_DIR=$SUBJECT/temp/${CVE}-origin
...
TMP_OUT=tmp-out-origin
DIR_OUT=$DOWNLOAD_DIR/out/${CVE}-origin
...
do
	...
	#### valgrind ./${BUILD}/obj-${CVE}-2/binutils/cxxfilt < ./crashfile
        mv $DIR_OUT/target_$((i))_result  $DIR_OUT/../../$TMP_OUT/$1/
done
mv $DIR_OUT/../../$TMP_OUT/$1/target_*_result  $DIR_OUT/
